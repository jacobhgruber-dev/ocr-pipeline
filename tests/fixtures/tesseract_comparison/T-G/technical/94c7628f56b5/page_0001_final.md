<!-- doc:" ESP32 Series Datasheet" | lang: en | type: datasheet | page: 1 -->
...
| I_output^1 | Cumulative IO output current | — | 1200 | mA |
...
| :-------- | :---------- | :-- | :-- | :-- | :--- |
| VDDA, VDD3P3_RTC, VDD3P3, VDD_SDIO (3.3 V mode)^1 | Voltage applied to power supply pins per power domain | 2.3/3.0^2 | 3.3 | 3.6 | V |
| VDD3P3_CPU | Voltage applied to power supply pin | 1.8 | 3.3 | 3.6 | V |
| I_VDD | Current delivered by external power supply | 0.5 | — | — | A |
