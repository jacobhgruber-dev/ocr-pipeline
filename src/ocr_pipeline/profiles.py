...
_THEOLOGICAL_JOURNAL_PROMPT = (
    ...
    "   - If a table spans the full page width and has >5 columns, use a \n"
    "     compact format with column headers on separate lines\n"
    "8. If the page contains an image, figure, or illustration:\n"
    "   - Insert a placeholder: [Figure: brief description of what the image shows]\n"
    "   - If the image has a caption, include it after the placeholder\n"
    "   - Do NOT attempt to describe the image in detail -- a one-line description\n"
    "     of the subject matter is sufficient\n"
    "9. If the page contains dual-column layout, linearize left column "
    "first, then right.\n"
    "10. If the page contains footnotes, include them at the bottom "
    "prefixed with [^N]:\n"
    "    where N matches the superscript marker.\n"
    "11. Do NOT add interpretive notes, commentary, or translation.\n"
    "12. If all three OCR outputs agree on a passage, reproduce it "
    "verbatim.\n"
    "13. For ambiguous characters (e.g., u/v, i/j in ecclesiastical "
    "Latin), prefer the\n"
    "    reading most consistent with the document's orthographic style.\n"
    "14. Return ONLY the merged markdown -- no preamble, no explanation."
)
...
_ACADEMIC_PROMPT = (
    ...
    "   - Do NOT attempt to describe the image in detail -- a one-line description\n"
    "     of the subject matter is sufficient\n"
    "9. If the page contains footnotes, include them at the bottom prefixed with\n"
    "   [^N]: where N matches the superscript marker in the text.\n"
    "10. Preserve all citation metadata: author names, titles, publication "
    "dates,\n"
    "    journal/volume/issue numbers, DOIs, and page ranges.\n"
    "11. Preserve all bibliographic references exactly as printed.\n"
    "12. If the document follows Chicago Manual of Style (CMOS 18), ensure "
    "footnote\n"
...
_IRISH_HAGIOGRAPHY_PROMPT = (
    ...
    "   - Do NOT attempt to describe the image in detail -- a one-line description\n"
    "     of the subject matter is sufficient\n"
    "9. If the page contains footnotes, include them at the bottom prefixed "
    "with [^N]: where N matches the superscript marker in the text.\n"
    "10. SINGLE-COLUMN LAYOUT: The page is single-column. Do not attempt "
    "column detection or dual-column linearization.\n"
    "11. IRISH DIACRITICS ARE ORTHOGRAPHICALLY SIGNIFICANT: The fada "
    ...
    "image.\n"
    "12. MODERN IRISH ORTHOGRAPHY: Modern Irish uses u (not v) for the "
    "vowel. The letter v appears only in loanwords and Latin text. "
    "Do not convert u/v based on ecclesiastical Latin conventions.\n"
    "13. DICTIONARY FORMAT: Preserve headword boldness, definition "
...
_MATHEMATICAL_PROMPT = (
    ...
    "   - If a table spans the full page width and has >5 columns, use a \n"
    "     compact format with column headers on separate lines\n"
    "   - For numeric tables, preserve all decimal points and significant digits\n"
    "   - For statistical tables, preserve p-values, confidence intervals, and \n"
    ...
    "9. If the page contains footnotes, include them at the bottom prefixed with\n"
    "   [^N]: where N matches the superscript marker in the text.\n"
    "10. For mathematical expressions, use LaTeX math mode: $...$ for "
    "inline math and $$...$$ for display math. For multi-line equations, "
    "use \\\\begin{aligned}...\\\\end{aligned} inside $$...$$.\n"
    "11. For chemical formulas, superscripts, and subscripts, use the "
    "appropriate LaTeX notation (e.g., H$_2$O, E=mc$^2$).\n"
    "12. If the page contains citations, preserve them verbatim.\n"
    "13. Do NOT add interpretive notes, commentary, or translation.\n"
    "14. Return ONLY the merged markdown -- no preamble, no explanation."
)
...
_LEGAL_PROMPT = (
    ...
    "9. If the page contains footnotes, include them at the bottom prefixed with\n"
    "   [^N]: where N matches the superscript marker in the text.\n"
    "10. Preserve section numbering and legal citations exactly as printed. "
    "This includes section symbols (S), statute references (e.g., 42 "
    "U.S.C. S 1983), and case citations (e.g., Brown v. Board of "
    "Education, 347 U.S. 483 (1954)).\n"
    "11. Preserve all paragraph markers, subsection numbers, and "
    "indentation levels.\n"
...
_CITATION_FOCUSED_PROMPT = (
    ...
    "   - Do NOT attempt to describe the image in detail -- a one-line description\n"
    "     of the subject matter is sufficient\n"
    "9. CRITICAL: Preserve EVERY footnote marker ([^N]) and its corresponding "
    "text. Every footnote marker in the image must have a corresponding "
    "[^N]: entry at the bottom of the page.\n"
    "10. CRITICAL: Preserve EVERY citation in full. Pay extra attention "
    "to footnotes,\n"
    "    endnotes, parenthetical citations, and bibliographic entries.\n"
    "11. For references with DOIs, preserve the full DOI string.\n"
    "12. Mark any uncertain citations with [?].\n"
    "13. Do NOT normalize citation formats -- preserve the original "
