...
_ACADEMIC_PROMPT = (
    ...
    "5. Format as clean markdown. Use **bold** for headlines, *italic* "
    "for titles.\n"
    "6. Preserve all citation metadata: author names, titles, publication "
    "dates,\n"
    "   journal/volume/issue numbers, DOIs, and page ranges.\n"
    "7. Format footnotes with [^N]: markers.\n"
    "8. Preserve all bibliographic references exactly as printed.\n"
    "9. If the document follows Chicago Manual of Style (CMOS 18), ensure "
    "footnote\n"
...
_IRISH_HAGIOGRAPHY_PROMPT = (
    ...
    "7. IRISH DIACRITICS ARE ORTHOGRAPHICALLY SIGNIFICANT: The fada "
...
_MATHEMATICAL_PROMPT = (
    ...
    "5. Format as clean markdown. Use **bold** for headlines, *italic* "
    "for emphasis.\n"
    "6. For mathematical expressions, use LaTeX math mode: $...$ for "
    "inline math and $$...$$ for display math. For multi-line equations, "
    "use \\\\begin{aligned}...\\\\end{aligned} inside $$...$$.\n"
    "7. For chemical formulas, superscripts, and subscripts, use the "
    "appropriate LaTeX notation (e.g., H$_2$O, E=mc$^2$).\n"
    "8. If the page contains citations, preserve them verbatim.\n"
...
_LEGAL_PROMPT = (
    ...
    "must be a complete transcription.\n"
    "4. Mark any text you cannot read with [illegible].\n"
    "5. Format as clean markdown. Use **bold** for section headings, "
    "*italic* for case names and titles.\n"
    "6. Preserve section numbering and legal citations exactly as printed. "
    "This includes section symbols (S), statute references (e.g., 42 "
    "U.S.C. S 1983), and case citations (e.g., Brown v. Board of "
    "Education, 347 U.S. 483 (1954)).\n"
    "7. Preserve all paragraph markers, subsection numbers, and "
    "indentation levels.\n"
    "8. Do NOT add interpretive notes, commentary, or translation.\n"
...
_CITATION_FOCUSED_PROMPT = (
    ...
    "Every footnote marker in the image must have a corresponding "
    "[^N]: entry.\n"
    "8. For references with DOIs, preserve the full DOI string.\n"
    "9. Mark any uncertain citations with [?].\n"
    "10. Do NOT normalize citation formats -- preserve the original "
